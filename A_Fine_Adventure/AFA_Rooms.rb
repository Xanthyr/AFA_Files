$val_choice = ( "1" || "2" || "3" || "north" || "east" || "south" || "west")
...
The sounds of the birds chirping shift into a more human sound, and is far closer than you previously realized.
  ...
  loop do
    ...
    when choice == "3" || choice.include?("path" || "east" || "step")
      ...
      gets.chomp
      forest1
    when choice.include?("west" || "south" | "north")
      puts "\nThe foliage is far too thick, you can't go this way."
    when choice.include?("help" || "look")
      puts options
    when choice != $val_choice
